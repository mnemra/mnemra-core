...
> *Cross-reference (2026-07-07): for bundle-delivered plugins, a **distribution pre-phase** (verified fetch/unpack) precedes state 1 — its canonical bounds-first ordering and mechanics are owned by [P-0023-plugin-distribution](P-0023-plugin-distribution.md) D4; it is a pre-phase, not a tenth state here.*
